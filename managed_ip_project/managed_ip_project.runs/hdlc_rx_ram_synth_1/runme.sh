...
HD_PWD='C:/Users/zhang/Desktop/manage_ip/managed_ip_project/managed_ip_project.runs/hdlc_rx_ram_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log hdlc_rx_ram.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source hdlc_rx_ram.tcl
