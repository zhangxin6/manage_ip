...
HD_PWD='C:/Users/zhang/manage_ip/managed_ip_project/managed_ip_project.runs/pll_200_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log pll_200.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source pll_200.tcl
