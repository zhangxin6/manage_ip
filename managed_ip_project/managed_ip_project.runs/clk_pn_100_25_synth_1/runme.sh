...
HD_PWD='C:/Users/zhang/Desktop/manage_ip/managed_ip_project/managed_ip_project.runs/clk_pn_100_25_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log clk_pn_100_25.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source clk_pn_100_25.tcl
