...
HD_PWD='C:/Users/zhang/Desktop/manage_ip/managed_ip_project/managed_ip_project.runs/flag_insert0_ram_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log flag_insert0_ram.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source flag_insert0_ram.tcl
