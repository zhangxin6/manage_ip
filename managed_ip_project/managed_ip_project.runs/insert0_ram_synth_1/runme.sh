...
HD_PWD='C:/Users/zhang/Desktop/manage_ip/managed_ip_project/managed_ip_project.runs/insert0_ram_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log insert0_ram.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source insert0_ram.tcl
